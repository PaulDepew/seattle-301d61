...
function displayPics(){
  ...
  // While the variable 'rando' is defined correctly in the function displayPics, because it is a let variable, it is scoped to the code block and not globally scoped.
  console.log(viewed);
